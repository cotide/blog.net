...
(function () {
    ...
    */
    var URL = window.UEDITOR_HOME_URL || "/Scripts/lib/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'emotion', 'insertimage', 'scrawl', 'insertvideo', 'music', 'attachment', 'map', 'gmap', 'insertframe', 'insertcode', 'webapp', 'pagebreak', 'template', 'background', '|',
